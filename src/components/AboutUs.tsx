    ...
    return (
        <AboutUsWrapper>
            ...
            <TextSection>
                ...
                <Typography variant="subtitle2" fontStyle={"italic"} fontSize="1.25rem" sx={{ color: 'white', mt: 2, width: '60%' }}>
            ...
            <ImageSection>
                <img src="about-us-image.png" alt="About Us Image" style={{ objectFit: 'fill', width: '100%', height: '100%' }} />
            </ImageSection>
